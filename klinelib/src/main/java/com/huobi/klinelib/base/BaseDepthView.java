...
import com.huobi.klinelib.draw.DepthDraw;
import com.huobi.klinelib.draw.DepthLabelDraw;
import com.huobi.klinelib.utils.Constants;
...
public class BaseDepthView extends View implements View.OnTouchListener {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (dataAdapter != null && dataAdapter.getCount() > 0) {
            ...
            //坐标系
            labelDraw.drawLabels(canvas, dataAdapter.getMaxIndex(), dataAdapter.getMaxValue(),
                    dataAdapter.getMinIndex(), dataAdapter.getMinIndex());
            depthDraw.drawDepth(canvas, tempLeftDatas,
                    tempRightDatas, dataAdapter.getMaxValue(),
                    dataAdapter.getMinValue(), dataAdapter.getMaxIndex(), dataAdapter.getMinIndex());
            //选中
            if (isSelected) {
    ...
    public void setxDecimal(int xDecimal) {
        labelDraw.setxDecimal(xDecimal);
    }
    ...
    public void setyDecimal(int yDecimal) {
        labelDraw.setyDecimal(yDecimal);
    }
